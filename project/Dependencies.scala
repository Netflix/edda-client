...
object Dependencies {
  ...
  val iepConfig       = "com.netflix.iep" % "iep-config" % "0.1.12-SNAPSHOT"
  val iepNflxEnv      = "com.netflix.iep" % "iep-nflxenv" % "0.1.12-SNAPSHOT"
  val iepRxHttp       = "com.netflix.iep" % "iep-rxhttp" % "0.1.12-SNAPSHOT"
