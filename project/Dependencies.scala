...
object Dependencies {
  ...
  val iepConfig       = "com.netflix.iep" % "iep-config" % "0.1.13"
  val iepNflxEnv      = "com.netflix.iep" % "iep-nflxenv" % "0.1.13"
  val iepRxHttp       = "com.netflix.iep-shadow" % "iepshadow-iep-rxhttp" % "0.1.13"
  val junit           = "junit" % "junit" % "4.10"
  val junitInterface  = "com.novocode" % "junit-interface" % "0.11"
  val jzlib           = "com.jcraft" % "jzlib" % "1.1.3"
  val rxjava          = "com.netflix.iep-shadow" % "iep-rxjava" % "1.0.8"
